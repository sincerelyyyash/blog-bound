      ...
      var e = { 800: (e2, t2, r2) => {
        ...
        function n2(e3, n3) {
          for (var a = {}, i = [], c = 0; c < e3.length; c++) {
            ...
            if (-1 !== u)
              t2[u].references++, t2[u].updater(f);
            else {
              var g = o(f, n3);
      ...
      return (() => {
        ...
        var _ = function() {
          function e3(t3) {
            ...
            }(this, e3), this.api = o3, this.defaultType = n3.defaultType || e3.DEFAULT_TYPE, this.defaultAlign = n3.defaultAlign || e3.DEFAULT_ALIGN_TYPE, this.messagePlaceholder = n3.messagePlaceholder || e3.DEFAULT_MESSAGE_PLACEHOLDER, this.data = { type: e3.ALERT_TYPES.includes(r3.type) ? r3.type : this.defaultType, align: e3.ALIGN_TYPES.includes(r3.align) ? r3.align : this.defaultAlign, message: r3.message || "" }, this.container = void 0, this.readOnly = a2;
          }
          var r2, n2, o2;
          return r2 = e3, n2 = [{ key: "CSS", get: function() {
            ...
            var t3 = this, r3 = e3.ALERT_TYPES.map(function(e4) {
          ...
          } }, { key: "_changeAlertType", value: function(t3) {
            var r3 = this;
            this.data.type = t3, e3.ALERT_TYPES.forEach(function(e4) {
              var n3 = r3.CSS.wrapperForType(e4);
            ...
            for (var a2 in Array.isArray(r3) ? (t3 = o3.classList).add.apply(t3, v(r3)) : r3 && o3.classList.add(r3), n3)
              o3[a2] = n3[a2];
            return o3;
