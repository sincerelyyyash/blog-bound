      ...
      return function(t) {
        ...
        function p(t2, e2) {
          for (var n2 = 0; n2 < t2.length; n2++) {
            ...
            if (r2) {
              r2.refs++;
              for (var s2 = 0; s2 < r2.parts.length; s2++)
                r2.parts[s2](o2.parts[s2]);
              for (; s2 < o2.parts.length; s2++)
                r2.parts.push(g(o2.parts[s2], e2));
            } else {
              var a2 = [];
              for (s2 = 0; s2 < o2.parts.length; s2++)
                a2.push(g(o2.parts[s2], e2));
        ...
        function h(t2, e2) {
          ...
          var o2 = u[u.length - 1];
          if ("top" === t2.insertAt)
            o2 ? o2.nextSibling ? n2.insertBefore(e2, o2.nextSibling) : n2.appendChild(e2) : n2.insertBefore(e2, n2.firstChild), u.push(e2);
        ...
        var i = function() {
          ...
          return r(t2, [{ key: "state", get: function() {
            ...
            try {
              ...
              }, a = this.optionButtons[Symbol.iterator](); !(n2 = (i2 = a.next()).done); n2 = true)
                s();
            } catch (t4) {
              o2 = true, r2 = t4;
            } finally {
